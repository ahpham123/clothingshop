document.addEventListener('DOMContentLoaded', async function() {
    ...
    function displayProducts(products, containerId) {
        ...
        `;
            ...
            // Add expandable functionality if title is long
            const titleElement = productCard.querySelector('.product-title');
            if (product.title.length > 60) { // Adjust this threshold as needed
                titleElement.classList.add('expandable');
                titleElement.addEventListener('click', function() {
                    this.classList.toggle('expanded');
                    const container = this.closest('.product-title-container');
        ...
        document.querySelectorAll('.add-to-cart').forEach(button => {
            button.addEventListener('click', function() {
                addToCart(this.getAttribute('data-id'), this);
            });
        });
    }
